 ...
 *   + n2: 3
 *
 * Generated at: 2020-03-24 17:13:56.539298
 *
 */
#include <stdlib.h>
 ...
 */
extern int phi_DGPNewwDlKUPaKWHqFXm(
 ...
 */
extern int grad_phi_DGPNewwDlKUPaKWHqFXm(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_DGPNewwDlKUPaKWHqFXm(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_DGPNewwDlKUPaKWHqFXm(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_DGPNewwDlKUPaKWHqFXm(
        args__,
        result_space_cost,
...
int grad_cost_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_DGPNewwDlKUPaKWHqFXm(
        args__,
        result_space_grad,
...
int mapping_f1_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_DGPNewwDlKUPaKWHqFXm
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_DGPNewwDlKUPaKWHqFXm(
        args__,
        result_space_f1,
...
int mapping_f2_function_ref_point(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_DGPNewwDlKUPaKWHqFXm
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_DGPNewwDlKUPaKWHqFXm(
        args__,
        result_space_f2,
