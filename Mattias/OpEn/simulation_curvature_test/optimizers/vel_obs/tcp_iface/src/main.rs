///
/// Auto-generated TCP server for optimizer: vel_obs
/// Generated at: 2020-04-02 12:13:37.675028
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != VEL_OBS_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != VEL_OBS_NUM_PARAMETERS {
