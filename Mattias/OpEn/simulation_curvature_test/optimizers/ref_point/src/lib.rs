...
//
// Generated at: 2020-04-07 14:10:25.914812
//
...
const EPSILON_TOLERANCE: f64 = 1e-09;
...
const CONSTRAINTS_XMIN :Option<&[f64]> = Some(&[0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,0.1,-3.0,]);
...
pub fn initialize_solver() -> AlmCache {
    let panoc_cache = PANOCCache::new(REF_POINT_NUM_DECISION_VARIABLES, EPSILON_TOLERANCE, LBFGS_MEMORY);
    let alm_cache = AlmCache::new(panoc_cache, REF_POINT_N1, REF_POINT_N2);
...
pub fn solve(
    ...
    assert_eq!(p.len(), REF_POINT_NUM_PARAMETERS, "Wrong number of parameters (p)");
    assert_eq!(u.len(), REF_POINT_NUM_DECISION_VARIABLES, "Wrong number of decision variables (u)");
