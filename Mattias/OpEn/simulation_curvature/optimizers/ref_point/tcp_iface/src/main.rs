...
/// Generated at: 2020-04-02 12:03:39.232531
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != REF_POINT_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != REF_POINT_NUM_PARAMETERS {
